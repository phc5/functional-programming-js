...
function() {
	...
	// ------------ INSERT CODE HERE! -----------------------------------
  newReleases.forEach(function(pair) {
    videoAndTitlePairs.push({id: pair.id,title: pair.title});
  });
...
function() {
  ...
  return newReleases.map(function(pair) {
    return {id: pair.id, title: pair.title};
  });
...
Array.prototype.concatAll = function() {
    ...
    if (subArray.length === 1) {
      throw new Error("This is a one-dimensional array");
    }
...
function() {
	...
	return movieLists.
      ...
      return movieList.videos.concatMap(function(movie) {
        return movie.boxarts.reduce(function(boxartMap, current) {
